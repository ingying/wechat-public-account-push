export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxc02930b5a20d4a7d",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "d3e4bb825091ef07079f9d451e088d20",
  ...
  USERS: [kepadewx
    {
      ...
      id: "o21aC6uDQAcTVarhEp4LFAtRfhho",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "",
      // 所在省份
      province: "黑龙江",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老公", "year": "2003", "date": "05-19"},
        {"type": "节日", "name": "在一起", "year": "2022", "date": "08-01"},
